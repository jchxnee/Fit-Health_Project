...
public class ChatBotController {
    ...
    public void init() {
        try {
            ...
            PagePdfDocumentReader pdfReader = new PagePdfDocumentReader(new ClassPathResource("FIT_HEALTH_guide.pdf"));
    ...
    public Map<String, Object> ask(@RequestBody Map<String, String> request) {
        ...
        try {
            ...
            String prompt = """
                    다음 FIT-HEALTH 사이트 이용 문서를 참고해서 질문에 답변해줘.
                    문서에 없는 내용은 '해당 정보는 고객센터로 문의해주세요.'라고 답변해줘.
                    \n\n[문서내용]\n
                    """ + context + "\n\n[질문]\n" + question;
